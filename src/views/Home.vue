<template>
  ...
  <div class="home">
    ...
    <h2 class="home__heading">Vous voici sur le blog de Jean Simondon</h2>

    <p class="home__content">Ce site a été réalisé dans le cadre de la formation APIDAE, afin de pratiquer le framework Vue JS.</p>

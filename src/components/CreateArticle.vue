<template>
    ...
    <div class="article">
        ...
        <input class="article__title" id="title" type="text" v-model="internalTitle" required />
        <label for="content">Content :</label>
        <textarea class="article__content" id="content" rows="30" cols="100" v-model="internalContent" required/>
...
export default {
  ...
  methods: {
    ...
    createOrSave() {
      ...
      // } else { // si on a déjà fait créer une fois, alors ça revient à faire du update (patch) // mais inutilisable pour le moment comme on ne détient pas l'id
